import pandas as pd
from fdth.make_fdt_format_classes import make_fdt_format_classes


def print_fdt_default(
    x,
    columns=range(6),
    round=2,
    ...
    **kwargs
    ...
    if format_classes:
        res.iloc[:, 0] = make_fdt_format_classes(
            res.iloc[:, 0].astype(str), right_tmp, pattern
        )
